...
export function GeneratorSetPage() {
    ...
    const relatedIndustries = [
        {
            id: 1,
            titleTh: 'การผลิตก๊าซชีวภาพ (Biogas)',
            titleEn: 'Biogas & Renewable Energy Plants',
            descTh: 'ใช้ผลิตและสำรองไฟฟ้าในระบบพลังงานชีวภาพ เพื่อเพิ่มความต่อเนื่องและประสิทธิภาพการใช้พลังงาน',
        ...
        {
            id: 2,
            titleTh: 'ฟาร์มปศุสัตว์ (Livestock Farm)',
            titleEn: 'Livestock & Smart Agricultural Farms',
            descTh: 'ใช้สำรองไฟฟ้าสำหรับระบบให้อาหารและระบายอากาศ เพื่อรักษาสภาพแวดล้อมและลดความเสี่ยงจากไฟฟ้าดับ',
        ...
        {
            id: 3,
            titleTh: 'ไซต์ก่อสร้าง (Construction Site)',
        ...
        },
        {
            ...
            descTh: 'ใช้เป็นระบบไฟฟ้าสำรองในอาคารสำคัญ เพื่อรักษาความต่อเนื่องของธุรกิจเมื่อเกิดไฟฟ้าดับ',
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col selection:bg-sky-500 selection:text-white">
            <Helmet>
                ...
                <meta property="og:url" content="https://agileassets.co.th/generator-set/" />
            </Helmet>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-16">
                            {((content.items && content.items.length > 0)
                                ? content.items.map((item) => ({
                                    ...
                                    image: item.image || 'https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=600&q=80',
                                    badge: item.badge || 'สำรองไฟฟ้าฉุกเฉิน',
                                }))
                                : relatedIndustries
                            ).map((m, idx) => (
