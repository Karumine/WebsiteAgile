    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col selection:bg-sky-500 selection:text-white">
            ...
            <main className="flex-1">
                ...
                <section id="knowledge" className="py-16 sm:py-24 bg-white dark:bg-slate-950">
                                ...
                                {filteredArticles.map((article, idx) => (
                                    <ScrollReveal key={article.id} animation="fade-up" delay={idx * 60}>
                                        <div
                                            ...
                                            className="h-full flex flex-col bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:border-sky-500/50 transition-all duration-300 group cursor-pointer"
                                        >
                                            {/* Thumbnail Image */}
                                            <div className="relative aspect-16/10 overflow-hidden bg-slate-100 dark:bg-slate-800">
                                                <img
                                                    ...
                                                    loading="lazy"
                                                />
                                                <div className="absolute top-3 left-3 px-3 py-1 rounded-lg bg-blue-900/90 backdrop-blur-md text-white text-[11px] font-bold shadow">
